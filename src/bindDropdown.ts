...
import { AlumisButtonAttributes } from './AlumisButtonAttributes';

export function bindDropdown(node: HTMLDivElement, dropdown: AlumisDropdown, attrs: AlumisButtonAttributes) {
